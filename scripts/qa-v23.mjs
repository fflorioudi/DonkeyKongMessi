...
pass("climb controls stay available for pre-input", controlsSource.includes("aria-hidden={false}") && stylesSource.includes(".climbCluster.isActive"));
pass("inactive climb controls remain tappable but dimmed", stylesSource.includes("opacity: 0.42") && stylesSource.includes("pointer-events: auto"));
